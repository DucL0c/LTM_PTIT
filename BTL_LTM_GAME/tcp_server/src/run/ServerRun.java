...
public class ServerRun {
    ...
    public static volatile Manager manager;
        ...
        try {
            ...
            while (!isShutDown) {
                try {
                    ...
                    ServerHandle c = new ServerHandle(s);
                    manager.add(c);
                    System.out.println("Count of client online: " + manager.getSize());
